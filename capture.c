...
static void usage(FILE *fp, int argc, char **argv)
{
        fprintf(fp,
		 ...
		 "-F | --formatMJPEG   Force format to 1280x720 MJPEG\n"
                 "-c | --count         Number of frames to grab [%i] - use 0 for infinite\n"
                 "\n"
		 "Example usage: capture -F -o -c 300 > output.mjpg\n"
		 "Captures 300 frames of MJPEG at 1920x1080 - use videoconv script to convert to mkv\n",
